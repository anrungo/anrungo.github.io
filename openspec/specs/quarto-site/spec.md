# quarto-site Specification

## Purpose

Defines how the personal/professional site is built and styled as a Quarto website project, including the "Clinical Clean" theme, navigation, content migration, and deployment to GitHub Pages.
